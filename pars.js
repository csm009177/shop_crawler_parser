...
const LinkMaker = require("./linkmaker");
...
class TemuProductParser {
  constructor(htmlFilePath) {
    ...
    this.inputFileName = path.basename(
      htmlFilePath,
    ...
    <div class="container">
        <div class="header">
            ...
            <div class="login-hint">
                💡 브라우저에서 <a href="https://www.temu.com" target="_blank" rel="noopener noreferrer">Temu에 로그인</a> 후 링크를 클릭하세요
            </div>
        </div>
...
if (require.main === module) {
  ...
  if (!inputFile) {
    console.log(
      "No input file specified. Processing all HTML files in get/ directory...",
    );
